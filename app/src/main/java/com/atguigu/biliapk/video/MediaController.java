...
import com.atguigu.biliapk.video.callback.MediaPlayerListener;
...
public class MediaController extends FrameLayout {
  ...
  private ImageView mDanmakuImage;
  ...
  private void initControllerView(View v) {
    ...
    mDanmakuImage = (ImageView) v.findViewById(R.id.media_controller_danmaku_switch);
    mDanmakuText = (TextView) v.findViewById(R.id.media_controller_danmaku_text);
